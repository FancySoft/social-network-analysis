...
public class AccountMatcher {
    private static final Logger log = Logger.getLogger(AccountMatcher.class.getName());
    ...
    public void match(boolean enableLda) {
        log.info("Start mtching with enableLDA=" + String.valueOf(enableLda));
        ...
        log.info("Success persent=" + String.valueOf(successPercent()));
    }
